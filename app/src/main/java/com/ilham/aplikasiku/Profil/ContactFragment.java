package com.ilham.aplikasiku.Profil;
...
public class ContactFragment extends Fragment {
    ...
    public void intentemail() {
        ...
        try {
             likeIng.setType("plain/text")
                    ...
                    .putExtra(Intent.EXTRA_SUBJECT, "Aplikasi.ku email test")
                    .putExtra(Intent.EXTRA_TEXT, "Hello. this is a message sent from Aplikasi.ku :-)");
    ...
    public void intentinstagram() {
        ...
        Uri uri = Uri.parse("https://www.instagram.com/ilhem.ramadhan/"+instagramName);
    ...
    public void intentfacebook() {
        facebookName = "ilham.ramadhan.750";
