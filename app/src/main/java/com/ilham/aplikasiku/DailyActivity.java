...
import com.ilham.aplikasiku.Daily.DailyFragment;
import com.ilham.aplikasiku.Daily.FriendlistFragment;
...
public class DailyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar();
        initComponent();
        replace_fragment(new DailyFragment());
    }
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle("Daily Activity");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.friend_list:
                        navigation.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                        replace_fragment(new FriendlistFragment());
                        return true;
                }
                return false;
            }
